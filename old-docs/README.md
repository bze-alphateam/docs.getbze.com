...
# 🗄️ Old Documentation (Deprecated)

{% hint style="danger" %}
**This documentation is deprecated.** These pages are kept here for reference while the BZE docs are being reorganized and rewritten. Content may be outdated or superseded — see the current documentation in the main navigation.
{% endhint %}
