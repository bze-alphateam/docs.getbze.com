...
{% hint style="warning" %}
All raffles have a set end date. When a raffle ends, the remaining pot is burned, with the amount and block height recorded on the blockchain and shown in the "Burner" section of the BZE app.
{% endhint %}
