...
Staking rewards can be created by anyone with any two tokens or the same token (for stake and as reward). **The user that creates the staking rewards will have to provide the daily rewards for others to enjoy.**&#x20;
